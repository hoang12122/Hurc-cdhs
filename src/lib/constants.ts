...
export const ROLE_ADMIN_PKTAT = 'Admin';
export const ROLE_L3_SPECIALIST = 'L3';
export const ROLE_L2_TECHNICIAN = 'L2';
export const ROLE_L1_OPERATOR = 'L1';
...
export const CORRECTIVE_ACTION_STATUSES = ['Mới', 'Đang thực hiện', 'Hoàn thành', 'Đã xác minh'];
...
export const INSPECTION_STATUSES = ['Mới', 'Đánh giá', 'Xử lý', 'Phản hồi', 'Đóng', 'Hủy'];
export const LOCKED_INSPECTION_STATUSES_FOR_NON_ADMIN = ['Đóng', 'Hủy'];
export const DNF_STATUSES = ['Mới', 'Đánh giá', 'Xử lý', 'Phản hồi', 'Đóng', 'Hủy'];
export const LOCKED_DNF_STATUSES_FOR_NON_ADMIN = ['Đóng', 'Hủy'];
export const HAZARD_STATUSES = ['Mới', 'Đánh giá', 'Xử lý', 'Phản hồi', 'Đóng', 'Hủy'];
export const LOCKED_HAZARD_STATUSES_FOR_NON_ADMIN = ['Đóng', 'Hủy'];
...
export const INSPECTION_STATUS_TRANSITIONS = transitions;
export const DNF_STATUS_TRANSITIONS = transitions;
export const HAZARD_STATUS_TRANSITIONS = transitions;

export const DNF_HAZARD_LEVELS = [{ id: 'general', label: { vi: 'General', en: 'General' }, icon: Icon, badgeVariant: 'default' }];
...
export const IMPROVEMENT_STATUSES = ['Mới', 'Đang xem xét', 'Đã duyệt', 'Đang thực hiện', 'Hoàn thành', 'Đã từ chối'];
