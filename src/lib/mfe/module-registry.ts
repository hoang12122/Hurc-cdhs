...
export const APP_MODULE_REGISTRY: AppModuleContract[] = [
  ...
  },
  {
    ...
    criticality: 'business',
    dataBoundary: 'mixed',
    allowedInboundEvents: ['asset:open-360', 'telemetry:updated', 'twin:health-updated'],
  ...
  },
  {
    ...
    name: 'IoT Operations',
    routePrefix: '/iot',
    owner: 'Engineering / OT / IT',
    runtimeMode: 'in-app',
    criticality: 'business',
    dataBoundary: 'mixed',
    allowedInboundEvents: ['telemetry:received', 'device:health-changed'],
    allowedOutboundEvents: ['telemetry:investigate', 'asset:open-360'],
    productionReadiness: 'needs-validation',
  },
  {
    id: 'data-platform',
    name: 'Data Platform Operations',
    routePrefix: '/data-platform',
    owner: 'Data Platform / IT',
    runtimeMode: 'in-app',
    criticality: 'business',
    dataBoundary: 'mixed',
    allowedInboundEvents: ['outbox:queued', 'pipeline:degraded'],
    allowedOutboundEvents: ['pipeline:replay-requested'],
    productionReadiness: 'needs-validation',
  },
  {
    id: 'mlops',
    name: 'MLOps and AI Reliability',
    routePrefix: '/mlops',
    owner: 'Engineering / AI',
    runtimeMode: 'in-app',
    criticality: 'supporting',
    dataBoundary: 'aiDb',
    allowedInboundEvents: ['model:drift-detected', 'model:approval-required'],
    allowedOutboundEvents: ['model:deployment-proposed'],
    productionReadiness: 'needs-validation',
  },
  {
    id: 'evidence-ledger',
    name: 'Evidence Ledger',
    routePrefix: '/evidence-ledger',
    owner: 'Safety / Compliance / IT',
    runtimeMode: 'in-app',
    criticality: 'supporting',
    dataBoundary: 'mixed',
    allowedInboundEvents: ['evidence:anchor-requested'],
    allowedOutboundEvents: ['evidence:anchored', 'evidence:verification-failed'],
    productionReadiness: 'needs-validation',
  },
  {
    id: 'example-module',
