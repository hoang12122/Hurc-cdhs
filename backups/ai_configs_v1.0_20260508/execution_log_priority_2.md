...
- **Chi tiết thực hiện:**
  ...
  - Thiết kế luồng hiển thị trong suốt (Transparent Flow): Hiển thị nguyên văn lời nói của kỹ sư, hiển thị các Tag thực thể AI bóc được (như `Toa 05`, `Mức độ: CAO`), và yêu cầu kỹ sư kiểm tra lại trước khi bấm Submit. Đảm bảo triết lý *Human-in-the-loop*.
- **Kết quả / Output:** 
