...
const config = {
  ...
  "inlineSchemaHash": "1716cc4e24163995a2ffaa1d3a7edb368882d8d8b01fa1434bf4d9532e6f32cc",
  "copyEngine": true
}
...
path.join(process.cwd(), ".prisma-runtime/ai/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl.so.node");
path.join(process.cwd(), ".prisma-runtime/ai/libquery_engine-linux-musl.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), ".prisma-runtime/ai/schema.prisma")
